...
function AlertasResumen({ alloc, patrimonio, objetivoFijaPct, toleranciaDistribucionPct }: {
  ...
  const { minGradoInversionPct, maxDuracionAnios, minLeyExtranjeraPct } = useObjetivoDuracion(active?.id);
  ...
  const alertas = [
    ...
    ...alertasBonos(resumenBonos(bonosCalc, riskFree), minGradoInversionPct, maxDuracionAnios, minLeyExtranjeraPct),
