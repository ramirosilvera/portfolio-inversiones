...
export const METRIC_CATALOG: MetricDef[] = [
  ...
  { key: 'bonos_distribucion_ley', categoria: 'Bonos', titulo: 'Ley aplicable', descripcion: 'Local vs. extranjera, % del capital en bonos.', shape: 'categorico', vizDisponibles: ['donut', 'bar', 'table'], vizDefault: 'donut', detalleHref: '/bonos' },
